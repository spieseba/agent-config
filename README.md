...
My current `CLAUDE.md` and collection of [Claude Code](https://docs.claude.com/en/docs/claude-code/overview) skills.
...
Clone the repo, then symlink (or copy) into Claude Code config directory:
...
My current `CLAUDE.md` is copied verbatim from [forrestchang/andrej-karpathy-skills](https://github.com/forrestchang/andrej-karpathy-skills) @ `2c60614`, which itself is derived from [Andrej Karpathy's observations](https://x.com/karpathy/status/2015883857489522876) on LLM coding pitfalls. It materializes the following four principles: *Think Before Coding*, *Simplicity First*, *Surgical Changes*, *Goal-Driven Execution*.

## Skills

- **`grill-me`** — Get extensively interviewed about a plan or design until every branch of the decision tree is resolved. This skill is inspired by [mattpocock/skills](https://github.com/mattpocock/skills) @ `b843cb5` and [obra/superpowers](https://github.com/obra/superpowers).
